...
LOCATION_COORDS = {
    "ревдамб": (49.043038, 33.147452),
    "ревовская дамба": (49.043038, 33.147452),
    "ревавська дамба": (49.043038, 33.147452),
    "дамба ревовка": (49.043038, 33.147452),
    "героїв україни": (49.0560, 33.2250),
    "героев украины": (49.0560, 33.2250),
    "вул героїв": (49.0560, 33.2250),
    "героев": (49.0560, 33.2250),
    ...
    "центр": (49.0558, 33.2252),
    "палац культури": (49.0555, 33.2265),
    "дк": (49.0555, 33.2265),
    "дитячий світ": (49.0560, 33.2215),
    "детский мир": (49.0560, 33.2215),
    "детском мире": (49.0560, 33.2215),
    "дитячому світі": (49.0560, 33.2215),
    "всесвіт": (49.0560, 33.2215),
    "всесвит": (49.0560, 33.2215),
    "голубом": (49.0545, 33.2255),
    "голубой": (49.0545, 33.2255),
...
def detect_status(text):
    ...
    # 🟢 Зелена — слова спокою (будь-де у тексті)
    green_keywords = [
        "спокійно", "сонце", "все ок", "чисто", "вільно", "тиша",
        "хорошо", "нормально", "все хорошо", "норма", "ок",
        "чисто", "вільна", "едет", "☀️", "🌞"
    ]
